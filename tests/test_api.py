...
class APITestCase(unittest.TestCase):
    ...
    def test_bad_auth(self):
        ...
        u = User(email='huangshujia@gracegene.com', password='cat', 
        ...
        response = self.client.get(
            ...
            headers=self.get_api_headers('huangshujia@gracegene.com', 'dog'))
    ...
    def test_token_auth(self):
        ...
        r = Role.query.filter_by(name='User').first()
        self.assertIsNotNone(r)
        u = User(email='huangshujia@gracegene.com', password='cat', confirmed=True,
                 role=r)
        db.session.add(u)
        db.session.commit()
        ...
        response = self.client.get(
            ...
            headers=self.get_api_headers('huangshujia@gracegene.com', 'cat'))
        self.assertTrue(response.status_code == 200)
        json_response = json.loads(response.data.decode('utf-8'))
